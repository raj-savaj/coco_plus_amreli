...
<head>
    ...
    <title>Change Password | Coco+</title>
            ...
            <div class="form-form-wrap">
                <div class="form-container">
                    <div class="form-content">
                        ...
                        <p class="">Update Your Password Here!</p>
                        @if (Session::get('error'))
                        <div class="alert alert-light-dager" role="alert">
                            <strong>Error!</strong> {{ Session::get('error') }}
                        </div>
                    @endif
                        <form method="POST" class="text-left" action="{{ action('Controller@updateAdminPassword') }}">
                            ...
                            <div class="form">
                                ...
                                <div id="username-field" class="field-wrapper input">
                                    ...
                                    <input id="username" name="oldpass" type="password" class="form-control" placeholder="Old Password">
                                </div>
                                <div id="username-field" class="field-wrapper input">
                                    <label for="username">NEW PASSWORD</label>
                                    <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="feather feather-user"><path d="M20 21v-2a4 4 0 0 0-4-4H8a4 4 0 0 0-4 4v2"></path><circle cx="12" cy="7" r="4"></circle></svg>
                                    <input id="username" name="newpass" type="password" class="form-control" placeholder="New Password">
                                </div>
                                <div id="username-field" class="field-wrapper input">
                                    <label for="username">CONFIRM PASSWORD</label>
                                    <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="feather feather-user"><path d="M20 21v-2a4 4 0 0 0-4-4H8a4 4 0 0 0-4 4v2"></path><circle cx="12" cy="7" r="4"></circle></svg>
                                    <input id="username" name="cnfpass" type="password" class="form-control" placeholder="Confirm Password">
                                </div>
